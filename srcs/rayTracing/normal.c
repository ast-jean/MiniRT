...
t_vector3d C, t_vector3d V, t_vector3d L)
{
...
t_vector3d obj_coord, t_shape shape, t_ray_hit hit)
{
	if (ft_strcmp(shape.id, "sp"))
		...
		vector3d_norm(vector3d_sub(\
		point3d_to_vector3d(init_vars()->light->coord), hit.coord))));
	else
